...
<c:if test="${page.currentPageCount>1}">
    ...
    <%--把传递过去的页码-1就行了--%>
    <a href="${page.url }?method=all&currentPageCount=${page.currentPageCount-1} ">
        上一步
    </a>
</c:if>
...
<c:forEach var="pageNum" begin="${page.startPage}" end="${page.endPage}">
    <a href="${page.url }?method=all&currentPageCount=${pageNum} ">
        [${pageNum}]&nbsp;
    </a>
</c:forEach>
...
<script type="text/javascript">
    ...
    function goPage() {
        ...
        window.location.href="${page.url }?method=all&currentPageCount="+value+" ";
    }
